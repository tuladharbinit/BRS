...
<head>
  ...
  <style>
    ...
    .form-row input { width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-size: 14px; }
...
<div class="change-pwd-form">
  ...
  <p style="color: #666; margin-bottom: 20px;">Logged in as <?= htmlspecialchars($u['email']) ?></p>
